...
if ( ! function_exists( 'sc_pagination' ) ) {
	function sc_pagination( $args = array(), $class = 'lt-pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'security' ),
				'next_text'          => __( '&raquo;', 'security' ),
				'screen_reader_text' => __( 'Posts navigation', 'security' ),
				'type'               => 'array',
