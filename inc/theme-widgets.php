...
if ( ! function_exists( 'sc_widgets_init' ) ) {
	/**
	...
	function sc_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'security' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'security' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'security' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'security' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer', 'security' ),
				'id'            => 'footer-full',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'security' ),
