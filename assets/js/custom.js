...
(function ($) {
  ...
  bezpekaModule = function () {
    ...
    return {
      ...
      sliderCity: function sliderCity() {
      ...
      choiceNext: function choiceNext() {
        function click() {
          setTimeout(function () {
            els.$calc_slider.slick('slickNext');
          }, 300);
      ...
      ajaxHandler: function ajaxHandler() {
      ...
      logosSlider: function logosSlider() {
      ...
      quizHandler: function quizHandler() {
      ...
      progressHandler: function progressHandler(slider) {
        slider.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
          ...
          }).attr('aria-valuenow', calcing); // els.$progress_bar_label.text( calcing + '% completed' );
        });
      },
      prevNextHandler: function prevNextHandler(slider, direction, e) {
        e.preventDefault();
